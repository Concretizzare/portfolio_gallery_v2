                ...
                return (
                  ...
                  >
                    ...
                    <motion.div
                      ...
                      className={`relative w-full h-[60svh] sm:h-auto sm:aspect-[16/10] md:aspect-[16/7] rounded-2xl md:rounded-3xl overflow-hidden ${
                    ...
                    >
                      ...
                      <div className="flex flex-col md:flex-row h-full">
                        ...
                        <div className="flex-1 flex flex-col justify-start md:justify-center px-4 pt-1 pb-4 sm:p-6 md:p-10 lg:p-12">
                          {/* Title */}
                          <motion.h2
